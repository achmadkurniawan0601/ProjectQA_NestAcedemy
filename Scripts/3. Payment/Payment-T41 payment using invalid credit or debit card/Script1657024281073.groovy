...
WebUI.setText(findTestObject('2. Payment/input_credit card'), '4911111111111114')
...
WebUI.verifyElementText(findTestObject('2. Payment/Alert_wrong number card'), 'Make sure your card number are correct.')
