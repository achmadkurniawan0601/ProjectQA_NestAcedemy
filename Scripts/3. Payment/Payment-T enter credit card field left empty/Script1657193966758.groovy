...
WebUI.setText(findTestObject('2. Payment/input_credit card'), '')
...
WebUI.verifyElementText(findTestObject('2. Payment/Alert_enter ur card number'), 'Please enter your card number.')
