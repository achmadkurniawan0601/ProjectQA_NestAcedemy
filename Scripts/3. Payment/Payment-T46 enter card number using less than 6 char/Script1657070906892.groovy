...
WebUI.setText(findTestObject('2. Payment/input_credit card'), '481111')
...
WebUI.verifyElementText(findTestObject('2. Payment/Alert_make sure correct card number'), 'Make sure your card number are correct.')
